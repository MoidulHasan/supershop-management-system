...
if(filter_input(INPUT_GET, 'incdec') == 'add'){
    //keep track of how mnay products are in the shopping cart
        $count = count($_SESSION['pointofsale']);
        ...
        $product_ids = array_column($_SESSION['pointofsale'], 'id');
          ...
          //product already exists, increase quantity
            ...
            for ($i = 0; $i < count($product_ids); $i++){
                if ($product_ids[$i] == filter_input(INPUT_GET, 'id')){
                    //add item quantity to the existing product in the array
                    $_SESSION['pointofsale'][$i]['quantity'] += 1;
                }
            }
}

if(filter_input(INPUT_GET, 'incdec') == 'dec'){
    //keep track of how mnay products are in the shopping cart
        $count = count($_SESSION['pointofsale']);
                    ...
                    <h4 class="m-1 text-lg text-primary">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Beverages" data-toggle="tab">Beverages</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Bakery" data-toggle="tab">Bread/Bakery</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Dairy" data-toggle="tab">Dairy</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#FrozenFoods" data-toggle="tab">Frozen Foods</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Meat" data-toggle="tab">Meat</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#PersonalCare" data-toggle="tab">Personal Care</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#PaperGoods" data-toggle="tab">Paper Goods</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#fruits" data-toggle="tab">Fruits</a>
                              </li>
                              <li class="nav-item">
...
<form role="form" method="post" action="pos_transac.php?action=add">
  ...
  <input type="hidden" name="role" value="<?php echo $_SESSION['JOB_TITLE']; ?>">
        ...
        <tr>  
          ...
          <td>
            <a href="pos.php?incdec=dec&id=<?php echo $product['id']; ?>">
                  <div class="btn btn-primary btn-xs">-</div>
              </a>
          </td>

           <td>
            <?php $productqnty=$product['quantity'];?>
            <input type="hidden" name="quantity[]" value="<?php echo $productqnty ?>">
            <?php echo $product['quantity']; ?>
          </td>  
          <td>
            <a href="pos.php?incdec=add&id=<?php echo $product['id']; ?>">
                  <div class="btn btn-primary btn-xs">+</div>
              </a>
          </td>
           <td>
