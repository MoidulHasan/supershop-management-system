            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['CNAME'].'</td>';
                      echo '<td class="text-center">
                                    <a href="pro_searchfrm.php?action=edit & id='.$row['PRODUCT_CODE'] . '"><img src="https://i.ibb.co/GTDGd2G/view.png" alt="View" border="0" width="30" height="30" /></a>
                                    <br> 

                                    <a href="pro_edit.php?action=edit & id='.$row['PRODUCT_ID']. '"><img src="https://i.ibb.co/4pQmLfz/edit.png" alt="Edit" border="0" width="30" height="30" /></a>
                                </td> ';
