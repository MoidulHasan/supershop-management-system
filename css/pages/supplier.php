        ...
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['PHONE_NUMBER'].'</td>';
                      echo '<td align="right"> 
                                  <a href="sup_searchfrm.php?action=edit & id='.$row['SUPPLIER_ID'] . '"><img src="https://i.ibb.co/GTDGd2G/view.png" alt="View" border="0" width="30" height="30" /></a>
                                    <br> 

                                    <a href="sup_edit.php?action=edit & id='.$row['SUPPLIER_ID']. '"><img src="https://i.ibb.co/4pQmLfz/edit.png" alt="Edit" border="0" width="30" height="30" /></a>
                                    </td>';
                      echo '</tr> ';
