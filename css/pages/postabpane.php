                            ...
                            <div class="tab-content">
                              <!-- 1ST TAB -->
                                <div class="tab-pane fade in mt-2" id="Beverages">
                                  <div class="row">
                                    ...
                                    ?>
                              <!-- 2ND TAB -->
                                <div class="tab-pane fade in mt-2" id="Bakery">
                                  <div class="row">
                              ...
                              <!-- 3rd TAB -->
                                <div class="tab-pane fade in mt-2" id="Dairy">
                                  <div class="row">
                              ...
                              <!-- 4th TAB -->
                                <div class="tab-pane fade in mt-2" id="FrozenFoods">
                                  <div class="row">
                              ...
                              <!-- 5th TAB -->
                                <div class="tab-pane fade in mt-2" id="Meat">
                                  <div class="row">
                              ...
                              <!-- 6th TAB -->
                                <div class="tab-pane fade in mt-2" id="PersonalCare">
                                  <div class="row">
                              ...
                              <!-- 7th TAB -->
                                <div class="tab-pane fade in mt-2" id="PaperGoods">
                                  <div class="row">
                              ...
                              <!-- 8th TAB -->
                                <div class="tab-pane fade in mt-2" id="fruits">
                                  <div class="row">
