                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
                  <thead>
                    ...
                    <?php                  
                      ...
                      echo '<td align="right"> <a href="emp_searchfrm.php?action=edit & id='.$row['EMPLOYEE_ID'] . '"><img src="https://i.ibb.co/GTDGd2G/view.png" alt="View" border="0" width="30" height="30" /></a>
                                    <br> 

                                    <a href="emp_edit.php?action=edit & id='.$row['EMPLOYEE_ID']. '"><img src="https://i.ibb.co/4pQmLfz/edit.png" alt="Edit" border="0" width="30" height="30" /></a></td>';
                        echo '</tr> ';
